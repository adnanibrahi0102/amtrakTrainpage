...
import { phoneNumber } from "../lib/phoneNumber"; // Assuming phoneNumber is exported from this file
...
const Banner = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: "url('https://images.unsplash.com/photo-1684709527501-e1c53c748b59?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
      }}
    >
